...
series_extracted=Funzioni.Stationarize_PSO_Window4_withoutYeo(train_set,counter_photo,period1,period2,period3,period4)
...
for ser in series_extracted:
    ...
    seriesTrasf1.index=ser.index
    result = Funzioni.StationarizeWithPSO_withoutYeo(seriesTrasf1,lamb,ser)
