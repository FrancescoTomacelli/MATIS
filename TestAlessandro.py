...
series= read_csv('D:/Universitaa/TESI/tests/Datasets/serie _reali/monthly-beer-production-in-austr.csv', header=0, index_col=0, parse_dates=True, squeeze=True)
...
forecastInverted.plot(color='red')
plt.show()
