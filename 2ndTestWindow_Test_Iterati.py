...
counter_test=10
i_test=1
for i_test in range(6,counter_test+1):
    ...
    newpath = r'D:/Universitaa/TESI/tests/immagini/test_' + str(i_test)
    os.makedirs(newpath)

    fil = open("D:/Universitaa/TESI/tests/immagini/test_"+str(i_test)+"/info.txt", "w+")
    fil.write('***** INFO ***** \n')
    ...
    random.seed()
    synSeries1 = Funzioni.GenerateSynSeries(500,50,trend1,100,1,period1,i_test)
    synSeries2 = Funzioni.GenerateSynSeries(500,50,trend2,100,1,period2,i_test)
    synSeries3 = Funzioni.GenerateSynSeries(500,50,trend3,100,1,period3,i_test)
    synSeries4 = Funzioni.GenerateSynSeries(500,50,trend4,100,1,period4,i_test)
    ...
    plt.savefig('D:/Universitaa/TESI/tests/immagini/test_'+str(i_test)+'/0_SeriesOriginal_' + str(period1) + '_' + str(period2) + '_' + str(period3) + '_' + str(period4) + '_' + str(period5) + '_' + str(counter_photo) + '_.png')
    ...
    series_extracted = Funzioni.Stationarize_PSO_Window4(train_set, counter_photo, period1, period2, period3, period4,i_test)
    ...
    for ser in series_extracted:
        ...
        result = Funzioni.StationarizeWithPSO_Original(ser,i_test)
        ...
        plt.savefig('D:/Universitaa/TESI/tests/immagini/test_'+str(i_test)+'/series_extracted' + str(extr_count) + '.png')
        plt.show()
    ...
    Funzioni.TestPrediction_AutoArima_Prophet_LSTM_Window90(series, seriesTrasf1Recostructed, seriesTrasf2Recostructed,
                                                            particle, lamb, counter_photo, train_set, test_set, scaler2,i_test)
